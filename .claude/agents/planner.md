...
## Output: `.gsd/active/<milestone>_<phase>_feature_spec.md` (e.g. `M4_P10_feature_spec.md`). Delete or ignore any other file left in `.gsd/active/` from a prior phase — `verifier` should have already archived it at `/steer`. Update `.gsd/STATE.json`'s `artifacts.active_spec` to this new filename.
